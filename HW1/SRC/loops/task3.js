...
console.log(`Методом последовательного подбора корень числа ${n} с точностью до целого равен `,i);
console.log(`Методом бинарного поиска корень числа ${n} с точностью до целого равен `,(a+b)/2);